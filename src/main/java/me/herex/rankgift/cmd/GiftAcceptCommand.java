...
public class GiftAcceptCommand implements CommandExecutor {
  private final RankGiftPlugin plugin;
  public GiftAcceptCommand(RankGiftPlugin plugin){ this.plugin = plugin; }
  ...
  @Override public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    ...
    plugin.getGiftManager().accept(p);
    return true;
  }
}
